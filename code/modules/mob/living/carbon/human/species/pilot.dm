/datum/species/yin
	...
	flags = NO_BREATHE | NO_SCAN | NO_BLOOD | NO_PAIN | NO_DNA | NOTRANSSTING | ALL_RPARTS
	tox_mod = 0
	clone_mod = 0
	oxy_mod = 0
...
/datum/species/yinslaved
	...
	flags = NO_BREATHE | NO_SCAN | NO_BLOOD | NO_PAIN | NO_DNA
...
/datum/species/yinslaved/updatespeciescolor(var/mob/living/carbon/human/H) //Lets slaves made from different species look different
	if(H.species.name == "Yin slave")
		switch(H.s_tone)
			if(9)
				icobase = 'icons/mob/human_races/yinslaved/r_yinvox.dmi'
				deform = 'icons/mob/human_races/yinslaved/r_yinvox.dmi'
				tail = "voxtail_gry"
				name = "Vox"
			if(8)
				icobase = 'icons/mob/human_races/yinslaved/r_yinvulpkanin.dmi'
				deform = 'icons/mob/human_races/yinslaved/r_yinvulpkanin.dmi'
				tail = "vulptail"
				name = "Vulpkanin"
			if(7)
				icobase = 'icons/mob/human_races/yinslaved/r_yintajaran.dmi'
				deform = 'icons/mob/human_races/yinslaved/r_yintajaran.dmi'
				tail = "tajtail"
				name = "Tajaran"
			if(6)
				icobase = 'icons/mob/human_races/yinslaved/r_yinlizard.dmi'
				deform = 'icons/mob/human_races/yinslaved/r_yinlizard.dmi'
				tail = "sogtail"
				name = "Unathi"
			if(5)
				icobase = 'icons/mob/human_races/yinslaved/r_yinkidan.dmi'
				deform = 'icons/mob/human_races/yinslaved/r_yinkidan.dmi'
				tail = "blank"
				name = "Kidan"
			if(4)
				icobase = 'icons/mob/human_races/yinslaved/r_yingrey.dmi'
				deform = 'icons/mob/human_races/yinslaved/r_yingrey.dmi'
				tail = "blank"
				name = "Grey"
			if(3)
				icobase = 'icons/mob/human_races/yinslaved/r_yindrask.dmi'
				deform = 'icons/mob/human_races/yinslaved/r_yindrask.dmi'
				tail = "blank"
				name = "Drask"
			if(2)
				icobase = 'icons/mob/human_races/yinslaved/r_yindiona.dmi'
				deform = 'icons/mob/human_races/yinslaved/r_yindiona.dmi'
				tail = "blank"
				name = "Diona"
			else
				icobase = 'icons/mob/human_races/yinslaved/r_yinslaved.dmi'
				deform = 'icons/mob/human_races/yinslaved/r_yinslaved.dmi'
				tail = "blank"
				name = "Human"
